...
public class AlarmStateListAdapter extends BaseAdapter implements View.OnClickListener
{
    public interface ListBtnClickListener {
        void onListBtnClick(int position) ;
    }
    static ArrayList<String> author_AppendData = new ArrayList<String>();
    static int authorDataLength;
    ...
    public AlarmStateListAdapter(Context context, List<list_author> List_ArrayAuthor, Activity parentActivity,ListBtnClickListener clickListener){
    ...
    public View getView( int i, View view, ViewGroup viewGroup) {
        ...
        authorDataLength++;
        author_AppendData.add((List_ArrayAuthor.get(i).getUserAuthor()).toString() );
