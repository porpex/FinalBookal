...
public class MyListAdapter2 extends BaseAdapter {
    ImageButton button;
    Context context;
    ArrayList<list_item2> list_itemArrayList2;
    ...
    public MyListAdapter2(Context context, ArrayList<list_item2> list_itemArrayList2) {
        this.context = context;
        this.list_itemArrayList2 = list_itemArrayList2;
    }
    @Override
    public int getCount() {
        return this.list_itemArrayList2.size();
    }

    @Override
    public Object getItem(int position) {
        return this.list_itemArrayList2.get(position);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewholder.title_textView.setText(list_itemArrayList2.get(position).getTitle() + " (상세정보)" );
        viewholder.au_textView.setText(list_itemArrayList2.get(position).getAuthor() );
        Glide.with(context).load(list_itemArrayList2.get(position).getCover()).into(viewholder.profile_imageView);
        ...
        Linkify.addLinks(viewholder.title_textView, pattern1, list_itemArrayList2.get(position).getLink().toString() ,null,mTransform);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String editBookName= list_itemArrayList2.get(position).getTitle();
                ...
                intent.putExtra("ImageUrl",list_itemArrayList2.get(position).getCover());
                intent.putExtra("Url",list_itemArrayList2.get(position).getLink());
