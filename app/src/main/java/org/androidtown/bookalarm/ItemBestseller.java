...
public class ItemBestseller extends AppCompatActivity {
    ...
    String url = "http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=ttbad46741530002&QueryType=Bestseller&MaxResults=20&start=1&SearchTarget=Book&output=xml&Version=20131101";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ItemBestseller.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    String getXmlData(){
                ...
                switch( eventType ){
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(tag.equals("item itemId")) ;// 첫번째 검색결과
                            ...
                            xpp.next();
                            title.add( Integer.toString(count) + "위. " + xpp.getText()); // 베스트셀러에 몇위인지 출력
                            count++;
                        }
