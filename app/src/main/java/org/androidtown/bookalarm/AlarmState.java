...
public class    AlarmState extends AppCompatActivity implements AlarmStateListAdapter.ListBtnClickListener {
    private ListView listView;
    private AlarmStateListAdapter adapter;
    private List<list_author> List_ArrayAuthor;
    //private List<list_author> sortAscList_Author;
    private AlarmStateListAdapter alarmstatelistadapter;
    TextView textview;
    String tempData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter spinAdapter = ArrayAdapter.createFromResource(this, R.array.orList, android.R.layout.simple_spinner_item);
        spinner.setAdapter(spinAdapter);


        ArrayAdapter<?> a8Adapter = ArrayAdapter.createFromResource(
                this, R.array.orList, R.layout.support_simple_spinner_dropdown_item);
        ...
        adapter = new AlarmStateListAdapter(getApplicationContext(), List_ArrayAuthor, this, this);
        ...
        try {
            ...
            String userAuthor, userDate, userImageUrl, userUrl, userBookName;
            ...
            while (count < jsonArray.length()) {
                ...
                Log.d("D1",  "Auhtor : " + userAuthor + "Date : " + userDate + "userImageUrl : " + userImageUrl + "\nurl : " + userUrl + "userBookName : " + userBookName);
                list_arrayauthor = new list_author(userAuthor,userDate,userImageUrl,userUrl, userBookName);
...
private final static Comparator<list_author> sortAscList_Author= new Comparator<list_author>() {
    ...
    private final static Comparator<list_author> sortAscList_Date= new Comparator<list_author>() {
        ...
        @Override
            public int compare(list_author object1,list_author object2) {
            String t1 = (String) (object1.getUserDate().substring(0,4) + object1.getUserDate().substring(5,7) + object1.getUserDate().substring(8,10) + object1.getUserDate().substring(11,13) + object1.getUserDate().substring(14,16) );
            String t2 = (String) (object2.getUserDate().substring(0,4) + object2.getUserDate().substring(5,7) + object2.getUserDate().substring(8,10) + object2.getUserDate().substring(11,13) + object2.getUserDate().substring(14,16) );
