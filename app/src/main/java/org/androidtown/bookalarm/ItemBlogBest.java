...
public class ItemBlogBest extends AppCompatActivity {
    ...
    String url = "http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=ttbad46741530002&QueryType=BlogBest&MaxResults=20&start=1&SearchTarget=Book&output=xml&Version=20131101";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ItemBlogBest.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    String getXmlData(){
