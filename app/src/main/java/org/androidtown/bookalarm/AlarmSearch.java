...
public class AlarmSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(setTitle.equals("title")){
            url = url + setData + "&QueryType=title&MaxResults=20&start=1&SearchTarget=Book&output=xml&Version=20131101";
        }
      else
      {
           url = url + setData + "&QueryType=author&MaxResults=20&start=1&SearchTarget=Book&output=xml&Version=20131101";
       }
        String str2;
        if(setTitle.equals("title"))
        str2 = "도서명";
        ...
        toolbar.setTitle(str2 +" : '" +setData+"' 검색 결과" );
